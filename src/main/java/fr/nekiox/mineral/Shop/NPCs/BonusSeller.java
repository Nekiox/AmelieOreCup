package fr.nekiox.mineral.Shop.NPCs;

import fr.nekiox.mineral.Shop.Categories.Abstract.Category;
import fr.nekiox.mineral.Shop.Categories.*;
import fr.nekiox.mineral.Shop.Items.AmeliorationTemporaire.AjouterVieSupplementaire;
import fr.nekiox.mineral.Shop.Items.AmeliorationTemporaire.DerniereChance;
import fr.nekiox.mineral.Shop.Items.AmeliorationTemporaire.PotionExperience;
import fr.nekiox.mineral.Shop.Items.Equipe.ActiverAnnonceProchainCoffre;
import fr.nekiox.mineral.Shop.Items.Equipe.SingleAreneTeleport;
import fr.nekiox.mineral.Shop.Items.Equipe.TeleportEquipeAreneAuto;
import fr.nekiox.mineral.Shop.Items.Informations.ProchainCoffreAreneItem;
import fr.nekiox.mineral.Shop.Items.Informations.ProchainLargageAerienPosition;
import fr.nekiox.mineral.Shop.Items.Informations.ProchainLargageAerienTemps;
import fr.nekiox.mineral.Shop.Items.Items.*;
import fr.nekiox.mineral.Shop.Items.Levelable.Pioche.Pioche1;
import fr.nekiox.mineral.Shop.Items.Levelable.Pioche.Pioche2;
import fr.nekiox.mineral.Shop.Items.Levelable.Pioche.Pioche3;
import fr.nekiox.mineral.Shop.Items.Permanent.AjoutCoeursPermanent;
import fr.nekiox.mineral.Shop.Items.Permanent.AutoLingot;
import fr.nekiox.mineral.Shop.Items.Permanent.EpeeDiamant;
import fr.nekiox.mineral.Shop.Items.Potions.PotionHaste;
import fr.nekiox.mineral.Shop.Items.Potions.PotionInvisibilite;
import fr.nekiox.mineral.Shop.Items.Potions.PotionSpeed1;
import fr.nekiox.mineral.Shop.Items.Potions.PotionSpeed2;
