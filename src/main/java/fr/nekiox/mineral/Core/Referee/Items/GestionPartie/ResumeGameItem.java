...
public class ResumeGameItem extends RefereeItemTemplate {

    public ResumeGameItem(Object target, InventoryTemplate inventaireSource) {
    ...
    public String getNomItem() {
        return Lang.referee_item_resume.toString();
    }
