package fr.nekiox.mineral;

import de.slikey.effectlib.EffectManager;
import fr.nekiox.custom_events.*;
import fr.nekiox.custom_plugins.CustomPlugin;
import fr.nekiox.custom_plugins.CustomPluginManager;
import fr.nekiox.data_storage.Data_EventHandler;
import fr.nekiox.data_storage.DatabaseInitialisation;
import fr.nekiox.data_storage.SQLConnection;
import fr.nekiox.file_manager.FileList;
import fr.nekiox.file_manager.RessourceFilesManager;
import fr.nekiox.groups.Core.Groupe;
import fr.nekiox.groups.GroupeExtension;
import fr.nekiox.groups.Utils.Etats;
import fr.nekiox.mapbuilder.MapBuilder;
import fr.nekiox.mineral.Commands.*;
import fr.nekiox.mineral.Core.Game.Game;
import fr.nekiox.mineral.Core.Game.JoinTeam.JoinTeamInventoryEvent;
import fr.nekiox.mineral.Core.MCPlayer;
import fr.nekiox.mineral.Core.Parachute.Events.ParachuteHitDetection;
import fr.nekiox.mineral.Core.Player.BaseItem.Commands.SetDefaultItems;
import fr.nekiox.mineral.Core.Player.BaseItem.Events.InventoryClick;
import fr.nekiox.mineral.Core.Referee.RefereeEvent;
import fr.nekiox.mineral.DeathAnimations.DeathAnimationManager;
import fr.nekiox.mineral.Events.*;
import fr.nekiox.mineral.Events.ArmorStandPickup;
import fr.nekiox.mineral.Translation.Lang;
import fr.nekiox.mineral.Utils.DisconnectedPlayer;
import fr.nekiox.mineral.Utils.Log.GameLogger;
import fr.nekiox.mineral.Utils.Log.Log;
import fr.nekiox.mineral.Utils.Player.PlayerUtils;
import fr.nekiox.mineral.Utils.UrlFetcher.Urls;
import fr.nekiox.mineral.Utils.VersionChecker.Version;
import fr.nekiox.special_events.SpecialEventManager;
...
public final class mineralcontest extends JavaPlugin {
    ...
    /**
     * Array of all the messages we can fetch from nekiox's plugin website.
     */
    @Getter
    ...
    private void registerEvents() {
        ...
        // Halloween
        //Bukkit.getServer().getPluginManager().registerEvents(new fr.nekiox.halloween_event.PlayerDeathEvent(), this);
        //Bukkit.getServer().getPluginManager().registerEvents(new fr.nekiox.halloween_event.OnGameStart(), this);
